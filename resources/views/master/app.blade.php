...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('dist') }}/assets/img/favicon/favicon.ico" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="#" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text text-uppercase fw-bold ms-2">chat-me</span>
                    </a>
                    ...
                    @foreach ($contacts as $c)
                        <li class="menu-item">
                            <a href="{{ route('chat.show', $c->rec->id) }}" class="menu-link">
                                ...
                                <div data-i18n="Analytics">{{ $c->rec->name }}</div>
                            </a>
                        </li>
                    @endforeach
                    <li class="menu-item">
                        <a href="{{ route('contact.create') }}" class="menu-link">
                            ...
                            <div data-i18n="Analytics">Tambah contact</div>
                        </a>
                    </li>
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                        ...
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset('dist') }}/assets/img/avatars/1.png" alt=""
